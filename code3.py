...
import github  # For exception handling
...
def api_upload():
    ...
    # Here you can call your existing upload_to_github function
    try:
        result = upload_to_github(username, token, detect_language(code), code)
